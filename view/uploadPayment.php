        ...
        <div class="col-12 rounded mx-auto isi">
            <div id="notCompleted">
                ...
                <div class="container text-right">
                    <button class="btn btn-hapus mb-3" onclick="hapus()" disabled>Hapus Gambar</button>
                </div>
                <div class="content">
                    <p class="text-white">File :</p>
                    <div class="text-center">
                        <form class="input-group mb-3" method="post" action="../controller/uploadPaymentProcess.php" enctype="multipart/form-data">
                            ...
                            <div class="container mt-3">
                                <button type="submit" value="submit" name="submit" class="btn rounded py-1 px-5 btn-checkout " disabled>Upload</button>
                            </div>
                        </form>
                    </div>
