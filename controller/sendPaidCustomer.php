...
//    $url = 'http://192.168.43.162:8001/items/ticket?fields=ticket_x_session.session_id';
    ...
    curl_setopt($curl, CURLOPT_URL, "http://192.168.18.76:8001/items/order?fields=customer_id,invoice_id.invoice_status,ticket_id.ticket_x_session.session_id&filter[invoice_id][invoice_status]=1");
...
//            echo $resultID['data'][$x]['ticket_id']['ticket_x_session'][$i]['session_id'];
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => "192.168.18.76:8002/items/registration?&filter[id_participant][_nin]=" . $resultID['data'][$x]['customer_id'],
