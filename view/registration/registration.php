        ...
        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 p-5 registrasi-side">
            ...
            <div class="registrasi-side-header mb-4">
                ...
                <blockquote class="blockquote text-center mb-3">
                    <p class="mb-0 font-italic gold h6">Get to know about something first, before you can love it better</p>
                    <footer class="blockquote-footer">Someone famous in <cite title="Source Title">Indonesia</cite></footer>
                </blockquote>
            </div>
